...
PARAMETERS: tuple[ParameterSpec, ...] = (
    ...
    _spec("secondary_jump_runup_via_multiplier", "Jump run-up multiplier", "Secondary coils", ParameterKind.FLOAT,
          "Advanced routing multiplier controlling receiver transition-via run-up distance.",
          basic=False, minimum=0, exclusive_minimum=True),
    _spec("secondary_jump_detour_via_multiplier", "Jump detour multiplier", "Secondary coils", ParameterKind.FLOAT,
          "Advanced routing multiplier controlling receiver transition-via detours.",
          basic=False, minimum=0, exclusive_minimum=True),
    _spec("cl1_transition_column_fraction", "CL1 transition column", "Secondary coils", ParameterKind.FLOAT,
          "Fraction of stroke used to position the CL1 transition columns. The recommended range is 0.02 to 0.05.",
          basic=False, minimum=0, maximum=0.5, exclusive_minimum=True),
    _spec("cl1_primary_end_min_clearance_mm", "CL1 primary end clearance", "Secondary coils", ParameterKind.FLOAT,
          "Minimum spacing maintained between the CL1 endpoint and primary end winding.",
          basic=False, unit="mm", minimum=0, exclusive_minimum=True),
